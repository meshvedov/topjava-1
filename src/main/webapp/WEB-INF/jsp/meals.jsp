            ...
            <div class="modal-body">
                <form class="form-horizontal" id="detailsForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="datetime-local" class="form-control" id="dateTime" name="dateTime" value="" placeholder="<spring:message code="meal.dateTime"/>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="number" class="form-control" id="calories" name="calories" value="" placeholder="<spring:message code="meal.calories"/>">
                        </div>
                    </div>
